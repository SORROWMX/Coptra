...
if ($isAjax) {
    ...
    <main></main>
            <main class="content-docs">
                ...
                <?php
                $prev_page = $root_path . 'docs/remotecontroller.php'; // Путь к предыдущей странице
                $next_page = $root_path . 'docs/navigationsystems/ultrasonic.php'; // Путь к следующей странице
