                ...
                <div class="documentation-content">
                    <section id="documentation" class="documentation">
                        ...
                        <div class="documentation-grid">
                            ...
                            <p>«Клевер123» — это учебный конструктор программируемого квадрокоптера, состоящего из популярных открытых компонентов, а также набор необходимой документации и библиотек для работы с ним.</p>
