        ...
        <section id="documentation-content" class="documentation-content">
            <section id="documentation" class="documentation">
                ...
                <div class="documentation-grid">
                    ...
                    <p>Скачать актуальную версию системы управления Коптра для вашей операционной системы можно в разделе "Прошивки и ПО". Простая установка и понятный интерфейс делают систему доступной для всех пользователей, независимо от уровня их подготовки.</p>
