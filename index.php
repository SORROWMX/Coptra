				...
				<div class="faq-container">
					<div class="faq-item">
						<div class="faq-question">
							...
							<span class="question-text">Какова дальность полета ваших дронов?</span>
					...
					<div class="faq-item">
						<div class="faq-question">
							<span class="faq-icon"><i class="fas fa-battery-three-quarters"></i></span>
							<span class="question-text">Как долго держится заряд батареи?</span>
							<span class="faq-toggle"><i class="fas fa-chevron-down"></i></span>
						</div>
						<div class="faq-answer">
							<p>
					...
					<div class="faq-item">
						<div class="faq-question">
							<span class="faq-icon"><i class="fas fa-video"></i></span>
							<span class="question-text">Какое качество видео обеспечивают камеры дронов?</span>
							<span class="faq-toggle"><i class="fas fa-chevron-down"></i></span>
						</div>
						<div class="faq-answer">
							<p>
