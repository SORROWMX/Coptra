<aside class="sidebar">
    <nav class="sidebar-nav">
        ...
        <div class="sidebar-item expandable">
            ...
            <ul class="sub-menu extended-submenu">
                <li><a href="/../docs/Software/coptra-station.php" data-ajax-load>Coptra drone control system</a></li>
                <li><a href="/../docs/Software/coptra-drone-sim.php" data-ajax-load>Coptra Sim</a></li>
            </ul>
        </div>
        <div class="sidebar-item expandable">
            <span class="sidebar-link">
